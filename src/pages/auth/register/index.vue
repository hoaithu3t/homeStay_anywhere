<template>
  ...
  >
    ...
    <a-form-item :name="['user', 'phoneNumber']" label="Phone number" :rules="[{ type: 'string' }]">
      <a-input v-model:value="formState.user.phoneNumber" />
    </a-form-item>
    <a-form-item :name="['user', 'gender']" label="Gender" :rules="[{ type: 'number' }]">
...
export default defineComponent({
  setup() {
        useMenu().onSelectedKeys(["auth-register"]);
